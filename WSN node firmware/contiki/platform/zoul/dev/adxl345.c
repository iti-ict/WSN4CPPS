...
accm_init(void)
{
  ...
  accm_write_reg(ADXL345_THRESH_TAP, ADXL345_THRESH_TAP_DEFAULT);
  accm_write_reg(ADXL345_OFSX, ADXL345_OFSX_DEFAULT);
  accm_write_reg(ADXL345_OFSZ, ADXL345_OFSY_DEFAULT);
  accm_write_reg(ADXL345_OFSZ, ADXL345_OFSZ_DEFAULT);
  accm_write_reg(ADXL345_DUR, ADXL345_DUR_DEFAULT);
  accm_write_reg(ADXL345_LATENT, ADXL345_LATENT_DEFAULT);
  accm_write_reg(ADXL345_WINDOW, ADXL345_WINDOW_DEFAULT);
  accm_write_reg(ADXL345_THRESH_ACT, ADXL345_THRESH_ACT_DEFAULT);
  accm_write_reg(ADXL345_THRESH_INACT, ADXL345_THRESH_INACT_DEFAULT);
  accm_write_reg(ADXL345_TIME_INACT, ADXL345_TIME_INACT_DEFAULT);
  accm_write_reg(ADXL345_ACT_INACT_CTL, ADXL345_ACT_INACT_CTL_DEFAULT);
  accm_write_reg(ADXL345_THRESH_FF, ADXL345_THRESH_FF_DEFAULT);
  accm_write_reg(ADXL345_TIME_FF, ADXL345_TIME_FF_DEFAULT);
  accm_write_reg(ADXL345_TAP_AXES, ADXL345_TAP_AXES_DEFAULT);
  i2c_single_send(ADXL345_ADDR, ADXL345_BW_RATE);
  accm_write_reg(ADXL345_BW_RATE, ADXL345_BW_RATE_DEFAULT);
  accm_write_reg(ADXL345_POWER_CTL, ADXL345_POWER_CTL_DEFAULT);
  accm_write_reg(ADXL345_INT_ENABLE, ADXL345_INT_ENABLE_DEFAULT);
  accm_write_reg(ADXL345_INT_MAP, ADXL345_INT_MAP_DEFAULT);
  accm_write_reg(ADXL345_DATA_FORMAT, ADXL345_DATA_FORMAT_DEFAULT);
  accm_write_reg(ADXL345_FIFO_CTL, ADXL345_FIFO_CTL_DEFAULT);
